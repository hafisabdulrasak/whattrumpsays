...
export function Hero() {
  return (
    <section
      ...
      className="rounded-3xl border border-[var(--border)] p-5 shadow-[var(--shadow-soft)] sm:p-7 md:p-10"
    >
      <p className="mb-2 text-[10px] uppercase tracking-[0.22em] text-[var(--accent)] sm:text-xs">Live Archive Interface</p>
      <h1 className="text-3xl font-black leading-tight text-[var(--text-primary)] sm:text-4xl md:text-5xl lg:text-6xl">What Trump Says</h1>
      <p className="mt-3 max-w-2xl text-base leading-7 text-secondary sm:mt-4 sm:text-lg">
        A reverse-chronological archive of Donald Trump’s public posts.
      </p>
      <p className="mt-4 max-w-3xl text-sm leading-6 text-muted sm:mt-5">
